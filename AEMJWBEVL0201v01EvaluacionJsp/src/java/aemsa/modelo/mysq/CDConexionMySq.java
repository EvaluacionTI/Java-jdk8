...
import aemsa.entidad.database.CEConexion;

public class CDConexionMySq {

    public static CDConexionMySq oCDInstancia = null;
    ...
    public static CDConexionMySq getInstancia(){
        
        if (oCDInstancia==null){
            oCDInstancia=new CDConexionMySq();
        }
