...
import aemsa.cap08.coleccion.logica.CLHashAbierto;
...
public class CV0601v02TestHashAbiertoMatricula
{
  public static void main(String[] args) throws IOException
  {
    ...
    n_elementos = CO06v01LeerTipoDato.datoInt();
    ...
    flujoS.print("matricula:  "); matricula = CO06v01LeerTipoDato.datoInt();
    while (matricula != 0)
    {
      flujoS.print("nombre:     "); nombre = CO06v01LeerTipoDato.dato();
