...
public class CV0301v03MostrarImagenAleatoria extends javax.swing.JFrame {
    
    //String sRutaImagen = "\\pe\\aemsa\\cap29\\swing04\\windows\\";
    String sRutaImagen = "/pe/aemsa/cap29/swing04/windows/";
    ...
    public CV0301v03MostrarImagenAleatoria() {
        initComponents();
    }
    ...
    private void jBtnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnMostrarActionPerformed
       ...
       // Class oClass = getClass();
        ...
        sRutaImagen = "F:/01NetBeans8.2/03Desarrollo/AEMJSEEVL0301v01EvaluacionJava-JDK8/src/resources/pe/aemsa/cap29/swing04/windows/AberdeenAngusMacho.jpg";
        
        URL url = this.getClass().getResource(sRutaImagen);
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CV0301v03MostrarImagenAleatoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CV0301v03MostrarImagenAleatoria().setVisible(true);
            }
        });
    }
