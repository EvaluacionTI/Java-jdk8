...
//
public abstract class CO17v02ArbolBinB {
    ...
    public Object borrar(Object obj) {
        ...
        {
            marcado = actual;
            if ((actual.izquierdo == null && actual.derecho == null)) // se trata de un nodo terminal (no tiene descendientes)
            {
                sucesor = null;
