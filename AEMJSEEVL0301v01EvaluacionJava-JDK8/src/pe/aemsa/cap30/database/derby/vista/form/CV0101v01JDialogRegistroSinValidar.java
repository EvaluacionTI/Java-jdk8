...
public class CV0101v01JDialogRegistroSinValidar extends javax.swing.JDialog {

    public CV0101v01JDialogRegistroSinValidar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CV0101v01JDialogRegistroSinValidar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CV0101v01JDialogRegistroSinValidar dialog = new CV0101v01JDialogRegistroSinValidar(new javax.swing.JFrame(), true);
