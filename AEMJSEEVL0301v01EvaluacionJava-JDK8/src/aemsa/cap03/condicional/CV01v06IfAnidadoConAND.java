...
public class CV01v06IfAnidadoConAND {

    public static void main(String[] args) {
        //1. Declarando variables
        double ldValorEntrada, ldRango1, ldRango2, ldRango3, ldRango4, ldRango5, ldRango6;
...
//                40                     0                  40                 100
        if (ldValorEntrada > ldRango1 && ldValorEntrada <= ldRango2) {
            ...
            System.out.println("|=========================|");
        }else if(ldValorEntrada >= ldRango3 && ldValorEntrada <= ldRango4) {
            lsPorcentaje = "6%";
            System.out.println("|===============================|");
            System.out.println("| 100.01   a 1000.00 |" + ldValorEntrada + " |" + lsPorcentaje + "|");
            System.out.println("|===============================|");
        }else if (ldValorEntrada >= ldRango5 && ldValorEntrada <= ldRango6) {
            lsPorcentaje = "7%";
            System.out.println("|==================================|");
