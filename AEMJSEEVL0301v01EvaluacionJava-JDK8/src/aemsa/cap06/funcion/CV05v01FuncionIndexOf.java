...
public class CV05v01FuncionIndexOf {

    public static boolean BuscarCadena(String cadena1, String cadena2) {
        // �cadena2 est� contenida en cadena1?
    ...
    public static void main(String[] args) {
        // main debe recibir dos o m�s par�metros: la cadena a buscar
        ...
        if (args.length < 2) {
            ...
            for (int i = 1; i < args.length; i++) // Buscar args[0] en args[i]
            {
