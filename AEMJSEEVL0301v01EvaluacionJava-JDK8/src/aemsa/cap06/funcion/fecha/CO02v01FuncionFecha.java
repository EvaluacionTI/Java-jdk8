...
//
public final class CO02v01FuncionFecha {
    // Atributos

    private int dia, mes, ano;

    // M�todos
    public CO02v01FuncionFecha() // constructor sin argumentos
    {
        asignarFecha(); // asignar fecha actual
    }

    public CO02v01FuncionFecha(int dd) // constructor con un argumento
    {
        //asignarFecha(); // asignar fecha actual
    ...
    public CO02v01FuncionFecha(int dd, int mm) // constructor con dos argumentos
    {
        asignarFecha(); // asignar fecha actual
        dia = dd;
        mes = mm;
    ...
    public CO02v01FuncionFecha(int dd, int mm, int aaaa) // constructor con tres argumentos
    {
        dia = dd;
        mes = mm;
        ano = aaaa;
    ...
    public CO02v01FuncionFecha(CO02v01FuncionFecha obj) // constructor copia
    {
        dia = obj.dia;
        mes = obj.mes;
        ano = obj.ano;
    ...
    public CO02v01FuncionFecha copiar(CO02v01FuncionFecha obj) {
        dia = obj.dia;
        mes = obj.mes;
        ano = obj.ano;
        return this;
