...
/////////////////////////////////////////////////////////////////
// Aplicaci�n que utiliza la clase CVector
//
public class CV01v06TamanoVector {
    // Visualizar un vector

    public static void visualizarVector(CO01v06TamanoVector v) {
        int ne = v.longitud();
        for (int i = 0; i < ne; i++) {
    ...
    public static void main(String[] args) {
         ...
         */
        double x[] = {1, 2, 3, 4, 5, 6, 7}; // matriz x
        CO01v06TamanoVector vector1 = new CO01v06TamanoVector(x);
        visualizarVector(vector1); // escribe 1 2 3 4 5 6 7

        CO01v06TamanoVector vector2 = new CO01v06TamanoVector(vector1);
        for (int i = 0; i < vector2.longitud(); i++) {
