...
public class CUTablaBaseArrayList extends AbstractTableModel implements Serializable {
    ...
    public CUTablaBaseArrayList() {
        this(0, 0);
    }

    public CUTablaBaseArrayList(int rowCount, int columnCount) {
        this(new ArrayList(columnCount), rowCount);
    }

    public CUTablaBaseArrayList(Object[][] data, Object[] columnNames) {
        DefaultTableModel m = null;
        setDataArray(data, columnNames);
    }

    public CUTablaBaseArrayList(Object[] columnNames, int rowCount) {
        this(convertToArrayList(columnNames), rowCount);
    }

    public CUTablaBaseArrayList(ArrayList columnNames, int rowCount) {
        setDataArray(new ArrayList(rowCount), columnNames);
    }

    public CUTablaBaseArrayList(ArrayList data, ArrayList columnNames) {
        setDataArray(data, columnNames);
    }
