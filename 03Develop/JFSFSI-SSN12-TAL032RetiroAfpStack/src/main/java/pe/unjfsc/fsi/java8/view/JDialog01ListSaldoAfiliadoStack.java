...
public final class JDialog01ListSaldoAfiliadoStack extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("JDialog01ListSaldoAfiliadoStack");
    private CESaldoAfiliado oCESaldo;
    private Stack<CESaldoAfiliado> oCEArray;
    private CIRetiroAFP25Stack oCIRetiroAFP;

    public JDialog01ListSaldoAfiliadoStack(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    protected String[][] loadData() {
        oCIRetiroAFP = new CMRetiroAFP25Stack();

        oCEArray = oCIRetiroAFP.consultaAllRetiroStack();
        LOG.info("[EVL] Numero collection : {}", oCEArray.size());
        return oCIRetiroAFP.convertStackToMatriz(oCEArray);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog01ListSaldoAfiliadoStack.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog01ListSaldoAfiliadoStack dialog = new JDialog01ListSaldoAfiliadoStack(new javax.swing.JFrame(), true);
