...
public class CV0101v02JFrame extends JFrame {
    // Referencias a los componentes

    private JLabel etiqueta;
    private JButton boton;
    // Otras referencias
    private static String mensaje = "..... Aplicacion Swing ..... !!!";

    private CV0101v02JFrame(String titulo) // constructor
    {
    ...
    public static void main(String[] args) {
        ...
        CV0101v02JFrame vPpal = new CV0101v02JFrame("Aplicaci�n Swing");
        vPpal.show();
    }
}