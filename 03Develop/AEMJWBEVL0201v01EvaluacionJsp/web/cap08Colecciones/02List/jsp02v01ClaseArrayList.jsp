<%-- 
    Fecha       :   12/01/2017
    Objetivo    :   Control de la clase ArrayList
    Descripción :   Generar una tabla de información de alumnos utilizando la clase ArrayList con
...
<html>
    ...
    <body>
         <%!
           ...
           ArrayList<CEAlumno> oLista = new ArrayList<CEAlumno>();
        %>
