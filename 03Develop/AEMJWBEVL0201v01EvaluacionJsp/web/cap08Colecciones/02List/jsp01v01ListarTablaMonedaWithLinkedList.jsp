...
<html>
    ...
    <body>
        ...
        <h1 id="idTitulo">Lista de Moneda: LinkedList - For</h1>
        ...
        <table id="idTabla">
            ...
            <%
                for (int i=0;i<=oLista.size()-1;i++){
            %>
            <tr>
                <td><%=oLista.get(i).getId()%></td>
                <td><%=oLista.get(i).getAbreviatura()%></td>
                <td><%=oLista.get(i).getCodigoNumero()%></td>
                <td><%=oLista.get(i).getCodigoLetra()%></td>
                <td><%=oLista.get(i).getDescripcion()%></td>                
            </tr>
            <%
                }
            %>
