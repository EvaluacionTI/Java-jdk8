...
public class CV0301v01JDialogActualizar extends javax.swing.JDialog {

    public CV0301v01JDialogActualizar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jTextFieldFechaSistema.setText(oFecha.toString());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CV0301v01JDialogActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CV0301v01JDialogActualizar dialog = new CV0301v01JDialogActualizar(new javax.swing.JFrame(), true);
