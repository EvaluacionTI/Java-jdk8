...
public final class jDialog08ListadoComprasNoCliente extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("jDialog08ListadoComprasNoCliente");
    private ArrayList<CECompraEfectuada> oCEArray;
    private CIMostrarListado oCIMostrarListado;

    public jDialog08ListadoComprasNoCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.detailNotBuy("0333141002");
        LOG.info("[EVL] Numero collection : {}", oCEArray.size());
        return oCIMostrarListado.convertNotBuyArrayListToMatriz(oCEArray);
    }
    ...
    private void jButtonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultarActionPerformed
        String[] aTitulo = {"Código Producto", "Cantidad", "Precio Unitario", "Total Venta"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog08ListadoComprasNoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog08ListadoComprasNoCliente dialog = new jDialog08ListadoComprasNoCliente(new javax.swing.JFrame(), true);
