...
public final class jDialog02ListadoClientes extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("jDialog02ListadoClientes");
    private ArrayList<CECliente> oCEArray;
    private CIMostrarListado oCIMostrarListado;

    public jDialog02ListadoClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.listaCliente();
        LOG.info("[EVL] Numero collection : {}", oCEArray.size());
        return oCIMostrarListado.convertArrayListToMatriz(oCEArray);
    }
    ...
    private void jButtonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultarActionPerformed
        String[] aTitulo = {"Código", "Apellidos y Nombres", "Correo", "No. DNI"};
        DefaultTableModel oModel = new DefaultTableModel(loadData(), aTitulo);

        jTableAllLinkedList.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog02ListadoClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog02ListadoClientes dialog = new jDialog02ListadoClientes(new javax.swing.JFrame(), true);
