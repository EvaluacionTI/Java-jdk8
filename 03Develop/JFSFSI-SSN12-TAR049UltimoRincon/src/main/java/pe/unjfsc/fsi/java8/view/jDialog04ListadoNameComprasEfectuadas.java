...
import pe.unjfsc.fsi.java8.entity.CECompraEfectuada;
import pe.unjfsc.fsi.java8.logical.CIMostrarListado;
import pe.unjfsc.fsi.java8.logical.impl.CMListadoUltimoRincon;

public final class jDialog04ListadoNameComprasEfectuadas extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("jDialog03ListadoComprasEfectuadas");
    private LinkedHashSet<CECompraEfectuada> oCEArray;
    private CIMostrarListado oCIMostrarListado;

    public jDialog04ListadoNameComprasEfectuadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.listaClientProductCompraEfectuada();
        LOG.info("[EVL] Numero collection : {}", oCEArray.size());
        return oCIMostrarListado.convertLinkedHashSetNameToMatriz(oCEArray);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Listado de Compras Efectuadas");
    ...
    private void jButtonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultarActionPerformed
        String[] aTitulo = {"Código Cliente", "Fecha Compra", "Código Producto", "Cantidad", "Precio Unitario", "Total Venta"};
        DefaultTableModel oModel = new DefaultTableModel(loadData(), aTitulo);

        jTableAllLinkedList.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog04ListadoNameComprasEfectuadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog04ListadoNameComprasEfectuadas dialog = new jDialog04ListadoNameComprasEfectuadas(new javax.swing.JFrame(), true);
