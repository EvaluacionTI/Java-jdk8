...
public class CDLoadData {
    ...
    public ArrayList<CECliente> loadCliente() {
        ...
        oListClient.add(new CECliente("0333132031", null, "0333132031@unjfsc.edu.pe", "P�REZ RIVERA GIANELA ESTHER"));
        oListClient.add(new CECliente("0333092018", null, "0333092018@unjfsc.edu.pe", "ALC�NTARA MIRANDA CARLOS ENRIQU"));
        ...
        oListClient.add(new CECliente("0333161010", null, "0333161010@unjfsc.edu.pe", "CH�VEZ OBREG�N LEONEL GUILLERMO"));
        ...
        oListClient.add(new CECliente("0333111040", null, "0333111040@unjfsc.edu.pe", "FLORES ROMERO EBL� CHRISTIAN"));
        oListClient.add(new CECliente("0333132017", null, "0333132017@unjfsc.edu.pe", "GARGATE TARAZONA JHIMI RUSVEL"));
        oListClient.add(new CECliente("0333152034", null, "0333152034@unjfsc.edu.pe", "LA ROSA FERN�NDEZ ANGELA ELIZAB"));
        ...
        oListClient.add(new CECliente("0333161034", null, "0333161034@unjfsc.edu.pe", "ORTIZ GARC�A ALISON GERALDINE"));
        oListClient.add(new CECliente("0333161045", null, "0333161045@unjfsc.edu.pe", "SANCHEZ CASTRO ROBERTO FREDI"));
        oListClient.add(new CECliente("0333161046", null, "0333161046@unjfsc.edu.pe", "URBANO LINO JHEYSSON JES�S"));
        oListClient.add(new CECliente("0333161048", null, "0333161048@unjfsc.edu.pe", "VARGAS LE�N BEATRIZ MILAGRITOS"));
