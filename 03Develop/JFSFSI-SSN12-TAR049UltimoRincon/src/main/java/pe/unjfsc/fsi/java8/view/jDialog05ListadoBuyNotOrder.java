...
public final class jDialog05ListadoBuyNotOrder extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("jDialog05ListadoBuyNotOrder");
    private ArrayList<CECompraEfectuada> oCEArray;
    private CIMostrarListado oCIMostrarListado;

    public jDialog05ListadoBuyNotOrder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.detailBuyNotOrder("0333151023");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog05ListadoBuyNotOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog05ListadoBuyNotOrder dialog = new jDialog05ListadoBuyNotOrder(new javax.swing.JFrame(), true);
