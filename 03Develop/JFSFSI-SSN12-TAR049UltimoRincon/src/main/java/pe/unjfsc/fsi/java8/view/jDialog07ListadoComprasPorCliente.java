...
public final class jDialog07ListadoComprasPorCliente extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("jDialog07ListadoComprasPorCliente");
    private ArrayList<CECompraEfectuada> oCEArray;
    private CIMostrarListado oCIMostrarListado;

    public jDialog07ListadoComprasPorCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.detailAccumulatedBuyOrder("0333151023");
        LOG.info("[EVL] Numero collection : {}", oCEArray.size());
        return oCIMostrarListado.convertBuyArrayListToMatriz(oCEArray);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog07ListadoComprasPorCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog07ListadoComprasPorCliente dialog = new jDialog07ListadoComprasPorCliente(new javax.swing.JFrame(), true);
