...
public final class jDialog03ListadoComprasEfectuadas extends javax.swing.JDialog {
    ...
    public jDialog03ListadoComprasEfectuadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.listaCompraEfectuada();
        LOG.info("[EVL] Numero collection : {}", oCEArray.size());
        return oCIMostrarListado.convertLinkedHashSetToMatriz(oCEArray);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog03ListadoComprasEfectuadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog03ListadoComprasEfectuadas dialog = new jDialog03ListadoComprasEfectuadas(new javax.swing.JFrame(), true);
