...
public final class jDialog06ListadoBuyOrder extends javax.swing.JDialog {

    private static final Logger LOG = LoggerFactory.getLogger("jDialog06ListadoBuyOrder");
    private ArrayList<CECompraEfectuada> oCEArray;
    private CIMostrarListado oCIMostrarListado;

    public jDialog06ListadoBuyOrder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected String[][] loadData() {
        ...
        oCEArray = oCIMostrarListado.detailBuyOrder("0333151023");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDialog06ListadoBuyOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDialog06ListadoBuyOrder dialog = new jDialog06ListadoBuyOrder(new javax.swing.JFrame(), true);
