...
import pe.aemsa.evalua.java8.logical.CD1301v01FramedArea;
...
public class CV1301v01PhilAnimator extends java.applet.Applet
    ...
    public Scrollbar grabDelaySlider = new Scrollbar(Scrollbar.HORIZONTAL,
						      5, 1, 0, 100);
    private Label label = new Label("  500 milliseconds");
    private CD1301v01FramedArea framedArea;
    ...
    public void init() {
        ...
        framedArea = new CD1301v01FramedArea(this);
